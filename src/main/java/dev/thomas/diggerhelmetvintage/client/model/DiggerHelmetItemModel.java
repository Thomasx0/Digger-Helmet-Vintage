...
public class DiggerHelmetItemModel extends AnimatedGeoModel<DiggerHelmetItem> {

    @Override
    public ResourceLocation getModelLocation(DiggerHelmetItem object) {
        return new ResourceLocation(DiggerHelmetVintage.MODID, "geo/digger_helmet_item.geo.json");
    }
    ...
    public ResourceLocation getAnimationFileLocation(DiggerHelmetItem animatable) {
        return new ResourceLocation(DiggerHelmetVintage.MODID, "animations/digger_helmet_item.animation.json");
    }
}
